...
from Manage import BOT_USERNAME, SUDOERS, app, eor
from Manage.core.decorators.errors import capture_err
from Manage.utils.dbfunctions import del_packname, get_packname, set_packname
from Manage.utils.files import (
    get_document_from_file_id,
    resize_file_to_sticker_size,
    upload_document,
)
from Manage.utils.stickerset import (
    add_sticker_to_set,
    create_sticker,
    create_sticker_set,
